...
function frame:OnEvent(event, arg1, ...)
	...
	if event == "PARTY_LEADER_CHANGED" and IsInGroup(1) and not Me.db.char.unitframes.enable then
	...
	if event == "GROUP_LEFT" and not IsInGroup(1) and Me.IsLeader( false ) and not Me.db.char.unitframes.enable then
